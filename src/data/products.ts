...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "Casquettes",
    description:
      "Casquette 5 panneaux en sergé et maille ton sur ton. Fermeture réglable plastique, visière courbée à coutures décoratives, bande de transpiration.",
    material: "Sergé et maille (composition non communiquée)",
    grammage: "Non communiqué",
    cut: "5 panneaux, visière courbée, fermeture réglable",
    sizes: ["U"],
    // Aucun packshot par coloris publie : seules les pastilles existent.
    packshotSource: "none",
    colors: [
  ...
  },
  {
    ...
    category: "Casquettes",
    description:
      "Casquette bicolore 5 panneaux, sergé et maille contrastée. Fermeture réglable plastique, visière courbée à coutures décoratives, bande de transpiration.",
    material: "Sergé et maille (composition non communiquée)",
    grammage: "Non communiqué",
    cut: "5 panneaux bicolore, visière courbée",
    sizes: ["U"],
    // Aucun packshot par coloris publie : seules les pastilles existent.
    packshotSource: "none",
    colors: [
  ...
  },
  {
    ...
    category: "Casquettes",
    description:
      "Casquette 6 panneaux en sergé coton lavé effet vintage. Fermeture réglable métal, 6 œillets de ventilation brodés ton sur ton, visière courbée.",
    material: "100 % coton (sergé)",
    grammage: "280 g/m²",
    cut: "6 panneaux, visière courbée, fermeture métal",
    sizes: ["U"],
    // Aucun packshot par coloris publie : seules les pastilles existent.
    packshotSource: "none",
    colors: [
